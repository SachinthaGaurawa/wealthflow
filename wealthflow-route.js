...
(function (root) {
    ...
    var RE_FUEL = /\b(fuel|petrol|diesel|petrol shed|fuel shed|filling station|fuel station|filling|ceypetco|lanka ioc|\bioc\b|sinopec|total energies|gas station|petroleum|dunhinda|rm parks|united petroleum|laugfs petroleum|ceylon petroleum|cpc filling|associated motorways|lioc|indian oil|petrol allowance|fuel allowance)\b/;
    ...
    var EXPENSE_CATS = [
        ...
        ['Groceries',     /\b(food city|cargills|keells|arpico|glomark|laughs|supermarket|grocery|spar|sathosa|super ?city|lanka sathosa|sunup|healthy living|jaya super|maharaja super|keells super|arpico supercentre|laugfs super|softlogic glomark|su711|maliban super|hyper ?market|mini ?mart|provision store|grocery mart|nihal stores|vishwa super|fresh mart)\b/],
        ['Dining',        /\b(restaurant|cafe|coffee|kfc|pizza|mcdonald|burger|hotel|bakery|dominos|barista|java|chai|karak|oishi|kottu|biryani|dinemore|perera and sons|pilawoos|subway|dunkin|sushi|ramen|noodles|hela bojun|chinese dragon|cool spot|sponge|nuga gama|ministry of crab|raja bojun|green cabin|bismillah|chooti|cinnabon|chatime|pizza hut|burger king|food court|fast food|take ?away|fried chicken|rice and curry|tea shop|eatery|nihonbashi|gallery cafe|the commons|coffee bean|whight|black cat|cafe kumbuk|kaema sutra|semondu|loon tao|bay leaf|beach wadiya|curry leaf|upali|shanmugas|palmyra|sea ?food|steak ?house|grill|barbeque|\bbbq\b|buffet|dessert|ice cream|juice bar|shawarma|donut|waffle|crepe|patisserie|confectionery|tea lounge|dosa|hoppers|string hopper|lamprais|bistro|canteen|cafeteria|snack bar|milk bar|cool bar|coffee shop)\b/],
        ['Fuel',          RE_FUEL],
        ['Transport',     /\b(uber|pickme|taxi|bus|train|railway|parking|toll|expressway|interchange|\brda\b|\betc\b|highway|wiper|tyre|tire|vehicle|auto ?parts?|spare ?parts?|service station|garage|leyland|car wash|pick me|kangaroo|three wheel|\bsltb\b|\bctb\b|\byego\b|emission test|kangaroo cab|budget taxi|ace cab|nano taxi|yoji|tuk ?tuk|three ?wheeler|trishaw|van hire|rent a car|car rental|self drive|revenue license|vehicle service|motor spares?|tyres?|battery|lubricant|wheel alignment|puncture|towing|breakdown|car park|vehicle park|season ticket)\b/],
        ['Utilities',     /\b(ceb|ceylon electricity|electricity|leco|water board|nwsdb|dialog|mobitel|slt|hutch|airtel|internet|broadband|recharge|reload|bill payment|gas|litro|laugfs gas|telecom|peo ?tv|dialog tv|lanka bell|electricity bill|water bill|sewerage|utility bill|prepaid meter|reconnection|meter reading|gas refill|gas cylinder)\b/],
        ['Health',        /\b(pharmacy|pharmacies|hospital|hospitals|medical|medicine|medicare|healthcare|health care|health|clinic|channel|channelling|e channel|e channelling|doc990|odoc|lab|laboratory|nawaloka|asiri|hemas|durdans|osu ?sala|healthguard|laksiri|ninewells|lanka hospital|browns hospital|union chemist|state pharmaceutical|dental|dentist|doctor|dispensary|drug store|drugstore|physiotherapy|physio|ayurveda|ayurvedic|surgery|optic|optical|optician|spectacle|eye clinic|eye hospital|x ray|xray|scan centre|scan center|nawaloka|asiri|hemas hospital|durdans|lanka hospitals?|ninewells|central hospital|golden key|navinna|delmon|city hospital|sunrise pharmacy|glaxo|no ?1 pharmacy|vitamins?|supplements?|nursing home|blood bank|vaccine|vaccination|consultation|diagnostic|radiology|\bmri\b|ultrasound|\becg\b|specialist|physician|maternity|dermatolog|cardio|ortho|paediatric)\b/],
        ['Shopping',      /\b(odel|nolimit|no limit|fashion|clothing|store|mall|cotton|kapruka|daraz|amazon|aliexpress|koko|mintpay|mint pay|ecom|showroom|singer|abans|softlogic|damro|\bdsi\b|\bbata\b|hameedia|house of fashion|cool planet|takas|wow lk|ikman|clicknshop|uniqlo|shein|\btemu\b|alibaba|fashion bug|glitz|carnival|emerald|kandy city|colombo city centre|one galle face|liberty plaza|majestic city|crescat|k[\s-]?zone|independence arcade|footwear|handbag|smartphone|laptop|apple store|samsung|huawei|xiaomi|redmi|\boppo\b|realme|home appliance|appliances|hardware|sanitary ware|furniture|homelux|home centre|department store|boutique|apparel|garment|textile|saree|fabric|toys|gift shop)\b/],
        ['Entertainment', /\b(cinema|movie|netflix|spotify|youtube|game|scope|pvr|savoy|majestic cine|playstation|\bxbox\b|nintendo|steam games|twitch|disney|hotstar|iflix|scope cinema|savoy|liberty cinema|majestic cineplex|regal cinema|empire cinema|mc cineplex|cineplex|\bimax\b|concert|live show|bowling|amusement|water park|karaoke|billiards|snooker|\bnlb\b|\bdlb\b|lottery|prime video)\b/],
        ['Education',     /\b(school|tuition|university|campus|course|institute|exam|books|royal college|british council|ielts|toefl|coursera|udemy|stafford|\bapiit\b|\bnsbm\b|\bsliit\b|\bcima\b|\bacca\b|montessori|pre[\s-]?school|day ?care|international school|college|academy|diploma|scholarship|library|book ?shop|book ?store|vijitha yapa|sarasavi|makeen|examination|edexcel|cambridge|pearson|kaplan|\baat\b|\bkdu\b|\bousl\b|open university|peradeniya|moratuwa|kelaniya|jayewardenepura|ruhuna|rajarata|wayamba|sabaragamuwa)\b/],
        ['Insurance',     /\b(insurance|aia|ceylinco|allianz|union assurance|sri lanka insurance|janashakthi|hnb assurance|softlogic life|amana takaful|fairfirst|cooplife|arpico insur|premium|life insurance|motor insurance|vehicle insurance|health insurance|travel insurance|\bpolicy\b|assurance|takaful|peoples insurance|continental insurance|orient insurance|lolc insurance|sanasa insurance|life cover|endowment)\b/],
